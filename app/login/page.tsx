...
export default function LoginPage() {
  ...
  return <main className="grid min-h-screen bg-[#f7f5fb] lg:grid-cols-[1.05fr_.95fr]">
    <section className="hidden flex-col justify-between bg-[#251d43] p-12 text-white lg:flex">
      <div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-[#7c6cff] font-bold">O</span><span className="text-lg font-semibold">Organiza</span></div>
